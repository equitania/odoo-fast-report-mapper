...
- [x] 01.1-07-PLAN.md — BUG-07: create_odoo_connection_from_yaml_object api_key support
...
- [x] 02-02-PLAN.md — Annotate _lang_utils.py (7 errors)
- [x] 02-03-PLAN.md — Annotate _logging.py (19 errors)
...
- [x] 02-06-PLAN.md — Annotate _connection.py Part 1: lines 1–496 (~30 errors)

**Wave 5** *(blocked on Wave 4 completion)*

- [x] 02-07-PLAN.md — Annotate _connection.py Part 2: lines 497–873 (~34 errors), remove override block

**Wave 6** *(blocked on Wave 5 completion)*

- [x] 02-08-PLAN.md — Annotate _cli.py (10 errors), remove all remaining overrides, enable CI enforcement
